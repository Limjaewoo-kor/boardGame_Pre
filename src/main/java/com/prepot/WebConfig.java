...
import com.prepot.argumentresolver.LoginMemberArgumentResolver;
import com.prepot.filter.LogFilter;
import com.prepot.filter.LoginCheckFilter;
import com.prepot.interceptor.LogInterceptor;
import com.prepot.interceptor.LoginCheckInterceptor;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LogInterceptor())
                ...
                .excludePathPatterns("/css/**", "/*.ico", "/error", "/img/**");  //이건 제외

        registry.addInterceptor(new LoginCheckInterceptor())
                .order(2)
                .addPathPatterns("/**")
                .excludePathPatterns("/","/member/add","/login","/home","/members/new"
                        ,"/logout","/css/**","/*.ico","/error", "/img/**");
    }
